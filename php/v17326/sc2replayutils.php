...
class SC2ReplayUtilsImpl extends SC2ReplayUtils {
	...
	public static $ABILITYCODES = array(
					    ...
					    0x010C20 => 'MULE',
					    0x012220 => 'Calldown: Extra supplies (Orbital command)', 
					    ...
					    0x003710 => 'Fungal growth (Infestor)',
					    ...
					    0x011F20 => 'Neural parasite (Infestor)',
					    ...
					    0x003800 => 'Guardian shield (Sentry)',
	...
	// returns the ability array for the specified ability code ($code) and game build ($build)
	// return false if the ability code is unknown
	static function getAbilityArray($code, $build) {
	  if (isset(self::$ABILITYCODES[$code])) {
	    $ability = self::$ABILITYCODES[$code];
